        ...
        <div class="col-md-3 col-sm-6 book-container">
            ...
            <div class="book-view book-closeview">
                <div class="cover-img">
                    <div class="front">
                        <div class="thumbnail-img">
                            <img class="card-img" src="images/ancient-books.jpg" alt="extra-danse">
                        </div>
                    </div>
                    <!--/.front-->
                    <div class="cover"></div>
        ...
        <div class="col-md-3 col-sm-6 book-container">
            ...
            <div class="book-view book-closeview">
                <div class="cover-img">
                    <div class="front">
                        <div class="thumbnail-img">
                            <img class="card-img" src="images/LaTex.jpg" alt="extra-danse">
                        </div>
                    </div>
                    <!--/.front-->
                    <div class="cover"></div>
        ...
        <div class="col-md-3 col-sm-6 book-container">
            ...
            <div class="book-view book-closeview">
                <div class="cover-img">
                    <div class="front">
                        <div class="thumbnail-img">
                            <img class="card-img" src="images/php-mysql-nuls.jpg" alt="extra-danse">
                        </div>
                    </div>
                    <!--/.front-->
                    <div class="cover"></div>
